...
const seedData = async () => {
  try {
    ...
    // Admin
    const adminHashedPassword = await bcrypt.hash("be.sky23", 12);
    await User.create({
      firstName: "Be",
      lastName: "Sky",
      email: "be.sky0121@gmail.com",
      password: adminHashedPassword,
      role: "admin",
      status: "Active",
    });
    console.log("Admin created: be.sky0121@gmail.com");
    ...
    const products = [
      ...
      },
      {
        ...
        price: 999,
        image:
          "https://images.unsplash.com/photo-1583496661160-fb4c88ce351c?auto=format&fit=crop&w=800&q=80",
        colors: ["Blue"],
      ...
      // Kids
      {
        ...
        price: 499,
        image:
          "https://images.unsplash.com/photo-1522771935876-2497116a7a9e?auto=format&fit=crop&w=800&q=80",
      ...
      },
      {
        ...
        price: 399,
        image:
          "https://images.unsplash.com/photo-1519235108751-14e20f2cd2dd?auto=format&fit=crop&w=800&q=80",
        colors: ["Red", "Yellow"],
